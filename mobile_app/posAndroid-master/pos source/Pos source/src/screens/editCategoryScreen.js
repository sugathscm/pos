        ...
        return (
            <Container>
                <Header>
                    ...
                    <Body style={{ flex: 1 }} >
                        <Title>{signUpStrings.editCategory}</Title>
                    </Body>
                    <Right>
                        ...
                        <Card style={{ marginLeft: wp('0%'), marginRight: wp('0%'), width: wp('100%'), marginTop: hp('0%') }}>
                            ...
                            <Content padder>
                                ...
                                <View style={{ marginBottom: hp('2%'), alignContent: 'center' }}>
                                    ...
                                    onPress={() => {
                                        this.props.navigation.navigate('AssignItemsEditScreen' , {data:this.state.data})
                                    }}>
...
export default connect(mapStateToProps, matchDispatchToProps)(EditCategory);