...
class LoginHelpScreen extends React.Component {
            ...
            <Container>
                <Header>
                    <Left style={{ flex:1 ,flexDirection: 'row'}}>
                        <Title>{signUpStrings.helpCenter}</Title>
                    </Left>
                    <Right>
                        <Icon active name="md-close" onPress={() => this.props.navigation.navigate('SignIn')}
                ...
                <Fab
                    ...
                    onPress={() => console.log("Sample Help")}>
...
export default connect(mapStateToProps, matchDispatchToProps)(LoginHelpScreen);
