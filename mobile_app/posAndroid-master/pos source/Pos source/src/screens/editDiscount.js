...
class EditDiscount extends React.Component {
    ...
    componentDidMount() {
        this.setState({
            ...this.state,
            pageLoading: false,
            discount:JSON.stringify(this.state.data.discount),
            selectedItem:this.state.data.itemName,
            selectedItemId:this.state.data.itemId
    ...
    submitForm() {
        ...
        let discount = {
            discountId:this.state.data._id,
        ...
        axios
            .post(AppURLS.ApiBaseUrl + 'discounts/editDiscount', discount)
            .then(response => {
                ...
                if (response.data.success) {
                    ...
                    this.forceUpdate();
                    this.showToast(`${signUpStrings.discountUpdatedSuccessfully}`,  `${signUpStrings.ok}`, `${signUpStrings.success}`);
                                ...
                                <Item style={{ borderBottomWidth: 0 }}>
                                    ...
                                    <Item floatingLabel style={{ width: wp('50%') }}>
                                        ...
                                        <Input onChangeText={text => {
                                            ...
                                            value={this.state.data.discount ? this.state.discount : ""}
...
export default connect(mapStateToProps, matchDispatchToProps)(EditDiscount);
